...
namespace AutoEmailService
{
    ...
    public partial class NedoDb : DbContext
    {
        public NedoDb()
            : base("name=NedoDb")
        {
        ...
        [DbFunction("NedoDb", "fn_query_text_from_handle")]
        public virtual IQueryable<fn_query_text_from_handle_Result> fn_query_text_from_handle(byte[] handle, Nullable<int> statement_start_offset, Nullable<int> statement_end_offset)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_query_text_from_handle_Result>("[NedoDb].[fn_query_text_from_handle](@handle, @statement_start_offset, @statement_end_offset)", handleParameter, statement_start_offsetParameter, statement_end_offsetParameter);
        }
    
        [DbFunction("NedoDb", "CalenderDates")]
        public virtual IQueryable<CalenderDates_Result> CalenderDates(Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<CalenderDates_Result>("[NedoDb].[CalenderDates](@StartDate, @EndDate)", startDateParameter, endDateParameter);
        }
    
        [DbFunction("NedoDb", "Split")]
        public virtual IQueryable<Split_Result> Split(string rowData, string splitOn)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Split_Result>("[NedoDb].[Split](@RowData, @SplitOn)", rowDataParameter, splitOnParameter);
        }
    
        [DbFunction("NedoDb", "fn_get_notable_query_plans")]
        public virtual IQueryable<fn_get_notable_query_plans_Result> fn_get_notable_query_plans(Nullable<int> source_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_notable_query_plans_Result>("[NedoDb].[fn_get_notable_query_plans](@source_id)", source_idParameter);
        }
    
        [DbFunction("NedoDb", "fn_get_notable_query_text")]
        public virtual IQueryable<fn_get_notable_query_text_Result> fn_get_notable_query_text(Nullable<int> source_id)
        {
            var source_idParameter = source_id.HasValue ?
                new ObjectParameter("source_id", source_id) :
                new ObjectParameter("source_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_notable_query_text_Result>("[NedoDb].[fn_get_notable_query_text](@source_id)", source_idParameter);
        }
    
        [DbFunction("NedoDb", "fn_get_performance_counter_statistics")]
        public virtual IQueryable<fn_get_performance_counter_statistics_Result> fn_get_performance_counter_statistics(string instance_name, string path_pattern, Nullable<System.DateTimeOffset> start_time, Nullable<System.DateTimeOffset> end_time)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_performance_counter_statistics_Result>("[NedoDb].[fn_get_performance_counter_statistics](@instance_name, @path_pattern, @start_time, @end_time)", instance_nameParameter, path_patternParameter, start_timeParameter, end_timeParameter);
        }
    
        [DbFunction("NedoDb", "fn_get_performance_counters")]
        public virtual IQueryable<fn_get_performance_counters_Result> fn_get_performance_counters(string instance_name, Nullable<System.DateTimeOffset> start_time, Nullable<System.DateTimeOffset> end_time)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_performance_counters_Result>("[NedoDb].[fn_get_performance_counters](@instance_name, @start_time, @end_time)", instance_nameParameter, start_timeParameter, end_timeParameter);
        }
    
        [DbFunction("NedoDb", "fn_get_query_text")]
        public virtual IQueryable<fn_get_query_text_Result> fn_get_query_text(Nullable<int> source_id, byte[] sql_handle, Nullable<int> statement_start_offset, Nullable<int> statement_end_offset)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_get_query_text_Result>("[NedoDb].[fn_get_query_text](@source_id, @sql_handle, @statement_start_offset, @statement_end_offset)", source_idParameter, sql_handleParameter, statement_start_offsetParameter, statement_end_offsetParameter);
        }
    
        [DbFunction("NedoDb", "fn_trace_gettable")]
        public virtual IQueryable<fn_trace_gettable_Result> fn_trace_gettable(Nullable<int> trace_info_id, Nullable<System.DateTimeOffset> start_time, Nullable<System.DateTimeOffset> end_time)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_trace_gettable_Result>("[NedoDb].[fn_trace_gettable](@trace_info_id, @start_time, @end_time)", trace_info_idParameter, start_timeParameter, end_timeParameter);
        }
    
        public virtual ObjectResult<AssignAnnualLeave_Result> AssignAnnualLeave()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AssignAnnualLeave_Result>("AssignAnnualLeave");
        }
        ...
        public virtual ObjectResult<Nstp_DdlLeaveRecord_By_ID_ForLates_Result> Nstp_DdlLeaveRecord_By_ID_ForLates(string empIds, Nullable<System.DateTime> fromDate)
        {
            var empIdsParameter = empIds != null ?
                new ObjectParameter("EmpIds", empIds) :
                new ObjectParameter("EmpIds", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nstp_DdlLeaveRecord_By_ID_ForLates_Result>("Nstp_DdlLeaveRecord_By_ID_ForLates", empIdsParameter, fromDateParameter);
        }
        ...
        public virtual ObjectResult<Nullable<System.Guid>> SqlQueryNotificationStoredProcedure_303e46c1_3806_430e_be6a_a938eae76620()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<System.Guid>>("SqlQueryNotificationStoredProcedure_303e46c1_3806_430e_be6a_a938eae76620");
        }
        ...
        public virtual ObjectResult<stp_GetEmployeeLates_Result> stp_GetEmployeeLates(string empIds, Nullable<System.DateTime> dateFrom, Nullable<System.DateTime> dateTo)
        {
            var empIdsParameter = empIds != null ?
                new ObjectParameter("EmpIds", empIds) :
                new ObjectParameter("EmpIds", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<stp_GetEmployeeLates_Result>("stp_GetEmployeeLates", empIdsParameter, dateFromParameter, dateToParameter);
        }
