...
(function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        pageNumber: 1,
        pageSize: 10,
        pageList: [10, 25, 50, 100, 500, 700, 900,1300,1500,1900,2200,2500,2700,3000,3500,4000,4500,5000],
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn' +
                ...
                '" id="xaviomrac" type="button" name="paginationSwitch" aria-label="pagination Switch" title="%s">',
